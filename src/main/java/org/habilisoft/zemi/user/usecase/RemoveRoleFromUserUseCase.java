...
public class RemoveRoleFromUserUseCase implements UseCase<Commands.RemoveRolesFromUser, Void> {
    private final UserRepository userRepository;

    @Override
    public Void execute(Commands.RemoveRolesFromUser removeRolesFromUser) {
