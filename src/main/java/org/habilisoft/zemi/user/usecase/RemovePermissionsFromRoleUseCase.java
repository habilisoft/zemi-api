...
public class RemovePermissionsFromRoleUseCase implements UseCase<UserCommands.RemovePermissionsFromRole, Void> {
    private final RoleRepository roleRepository;
    @Override
    public Void execute(UserCommands.RemovePermissionsFromRole removePermissionsFromRole) {
